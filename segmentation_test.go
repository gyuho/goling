...
func Test_GetSegment(t *testing.T) {
	...
	wordp1 := ConstructWordProb(OpenFile("traindata_Dixon.txt"))
	...
	wordp2 := ConstructWordProb(OpenFile("traindata_Dixon.txt"))
	...
	wordp3 := ConstructWordProb(OpenFile("traindata_Dixon.txt"))
